...
#include "../BomberMan3D/PostInvert.h"
#include "../BomberMan3D/PostChromaticAberration.h"
...
void PostProcessingScene::Initialize()
{
	...
	//AddPostProcessingEffect(new PostInvert{});
	AddPostProcessingEffect(new PostChromaticAberration{});
}
