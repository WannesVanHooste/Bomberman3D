...
#ifdef EXAM
#include "CourseObjects/BomberMan3D/BomberMan3DScene.h"
#include "CourseObjects/BomberMan3D/BomberMan3DMainMenu.h"
#include "CourseObjects/BomberMan3D/BomberMan3DControls.h"
#include "CourseObjects/BomberMan3D/BomberMan3DPauseMenu.h"
#endif
...
#ifdef EXAM
	SceneManager::GetInstance()->AddGameScene(new BomberMan3DScene());
	SceneManager::GetInstance()->AddGameScene(new BomberMan3DMainMenu());
	SceneManager::GetInstance()->AddGameScene(new BomberMan3DControls());
	SceneManager::GetInstance()->AddGameScene(new BomberMan3DPauseMenu());
	//SceneManager::GetInstance()->SetActiveGameScene(L"BomberMan3DScene");
