...
private:
	//LIGHT
	//*****
	DirectX::XMFLOAT3 m_LightDirection{0.57f,0.57f,0.57f};
	...
	DirectX::XMFLOAT4 m_ColorDiffuse{0,0,0,0};
	...
	//AMBIENT
	//*******
	DirectX::XMFLOAT4 m_ColorAmbient{0,0,0,0};
	static ID3DX11EffectVectorVariable* m_pAmbientColorVariable;
	float m_AmbientIntensity{5};
