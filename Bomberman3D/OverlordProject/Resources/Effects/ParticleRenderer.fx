...
void MainGS(point VS_DATA vertex[1], inout TriangleStream<GS_DATA> triStream)
{
   ...
   topLeft = float3(halfSize, halfSize, 0);
    ...
    CreateVertex(triStream, bottomLeft, float2(0, 0), vertex[0].Color, uvRotation);
    CreateVertex(triStream, topLeft, float2(0, 1), vertex[0].Color, uvRotation);
    CreateVertex(triStream, bottomRight, float2(1, 0), vertex[0].Color, uvRotation);
    CreateVertex(triStream, topRight, float2(1, 1), vertex[0].Color, uvRotation);
}
